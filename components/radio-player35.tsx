...
const STREAM_URL = "https://radio.bgermanov.eu/listen/radio_35/radio.mp3";
const API_URL = "https://radio.bgermanov.eu/api/nowplaying/5";

export function RadioPlayer35() {
