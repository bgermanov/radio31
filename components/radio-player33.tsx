...
const STREAM_URL = "https://radio.bgermanov.eu/listen/radio_33/radio.mp3";
const API_URL = "https://radio.bgermanov.eu/api/nowplaying/3";

export function RadioPlayer33() {
